  ...
  return (
    <div className="min-h-full bg-white text-gray-900">
      <div className="mx-auto px-3 py-6 sm:px-6 sm:py-10 max-w-[720px]">
        <Link to="/" className="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-900 mb-4 no-underline">
          <ArrowLeft size={14} /> Back to Dashboard
        </Link>

        <h1 className="text-2xl font-bold uppercase tracking-wider mb-6 sm:text-3xl sm:mb-8">
        ...
        <div className="space-y-4">
          {faqs.map((faq) => (
            <div key={faq.question} className="border border-gray-200 p-4 sm:p-5">
              <h3 className="font-bold text-sm mb-1 sm:text-base">{faq.question}</h3>
