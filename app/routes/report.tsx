  ...
  return (
    <div className="min-h-full bg-gray-50 text-gray-900 relative overflow-hidden">
      ...
      <div className="mx-auto px-3 py-6 sm:px-6 sm:py-10 max-w-[960px]">
        ...
        {/* Back link */}
        <Link to="/" className="inline-flex items-center gap-1 text-xs font-mono font-medium text-gray-400 hover:text-gray-900 mb-6 no-underline uppercase tracking-wider">
        ...
        <div className="bg-white border border-gray-200 mb-10 sm:mb-14">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-5 sm:p-8 flex flex-col justify-center">
              ...
              {!submittedFplId ? (
                <form onSubmit={handleFplIdSubmit}>
                  <label htmlFor="fplId" className="block text-xs font-mono font-semibold uppercase tracking-wider text-gray-400 mb-1.5">
                  ...
                  <div className="flex gap-0">
                    ...
                    <button
                      type="submit"
                      className="h-11 px-5 bg-gray-900 text-white text-sm font-mono font-semibold uppercase tracking-wider hover:bg-gray-700 disabled:opacity-20 disabled:cursor-not-allowed transition-colors cursor-pointer flex items-center gap-1.5 shrink-0"
            ...
            <div className="bg-gray-900 text-white p-5 sm:p-8 flex flex-col justify-center">
              <p className="text-xs font-mono font-semibold uppercase tracking-widest text-gray-500 mb-3">How to find your ID</p>
              <ol className="space-y-2.5 text-sm font-body font-normal text-gray-300">
              ...
              <div className="mt-4 p-3 bg-black/30 font-mono font-normal text-xs break-all text-gray-500 border border-gray-700 sm:text-sm">
          ...
          <div className="grid grid-cols-1 gap-3 mt-3 sm:grid-cols-3 sm:gap-4 sm:mt-4">
            ...
            <div className="bg-[#1a472a] text-white p-0 min-h-[200px] sm:min-h-[240px] relative overflow-hidden">
              ...
              <div className="relative z-10 p-4 sm:p-5">
                <p className="text-xs font-mono font-semibold uppercase tracking-widest text-white/40">Best XI</p>
                <p className="text-[10px] font-body font-normal text-white/30 mt-0.5">Highest-scoring possible lineup</p>
              </div>
            </div>
          </div>
        </div>
